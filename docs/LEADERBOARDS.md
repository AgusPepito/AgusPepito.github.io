...
- Each finished campaign level queues its time. A saved nickname enables automatic uploads. New players can leave the name blank and start racing immediately; without a nickname, completions wait locally for the player to choose one.
