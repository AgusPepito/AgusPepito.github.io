...
// public/assets/track/raised-cover-ramp-start-r3.js
function generate(THREE) {
  const family = "cover", kind = "ramp-start";
  ...
  if (kind === "ramp-start" || kind === "ramp-end") {
    let splitAtShoulder = function(geometry) {
    ...
    g.traverse((n) => {
      ...
      n.geometry = splitAtShoulder(n.geometry);
