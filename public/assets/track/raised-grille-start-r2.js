...
export default function generate(THREE) {
  const family = 'grille', kind = 'start', root = new THREE.Group();
  ...
  // Full-height end cheeks share the same interface across all service families. Ramp caps are separate assets.
