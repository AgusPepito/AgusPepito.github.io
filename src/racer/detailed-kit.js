import pipe_coupling from './recipe-assets/raised-pipe-coupling-r3.js';
import pipe_offset from './recipe-assets/raised-pipe-offset-r3.js';
import pipe_straight from './recipe-assets/raised-pipe-straight-r3.js';
import pipe_valve from './recipe-assets/raised-pipe-valve-r3.js';
import grille_lattice from './recipe-assets/raised-grille-lattice-r3.js';
import grille_louver from './recipe-assets/raised-grille-louver-r3.js';
import grille_reinforced from './recipe-assets/raised-grille-reinforced-r3.js';
import cover_end from './recipe-assets/raised-cover-end-r3.js';
import cover_hatch from './recipe-assets/raised-cover-hatch-r3.js';
import cover_plain from './recipe-assets/raised-cover-plain-r3.js';
import cover_ramp_end from './recipe-assets/raised-cover-ramp-end-r3.js';
import cover_ramp_start from './recipe-assets/raised-cover-ramp-start-r3.js';
import cover_segmented from './recipe-assets/raised-cover-segmented-r3.js';
import cover_start from './recipe-assets/raised-cover-start-r3.js';
import cover_vented from './recipe-assets/raised-cover-vented-r3.js';
import wallLights from './recipe-assets/sidewall-lights-r1.js';
